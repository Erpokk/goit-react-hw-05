        ...
        <section className="section">
            <div className="container">
                ...
                <div className={css.movieDetails}>
                     <picture>
                        <source media="(max-width: 768px)" srcSet={`${imgBaseUrl}w300${movie.poster_path}`} />
                        <source media="(min-width: 769px)" srcSet={`${imgBaseUrl}w400${movie.poster_path}`} />
                        <img
                            className={css.image}
                            src={movie.poster_path ? `${imgBaseUrl}w500${movie.poster_path}` : placeHolderImg}
                ...
                <ul className={css.infoList} >
                    <li className={css.infoItem} ref={castRef}>
                        <NavLink to="cast"  className={css.link} onClick={() => scrollToSection(castRef)} >Actors</NavLink>
                    </li>
                    <li className={css.infoItem} ref={reviewsRef}>
                        <NavLink to="reviews" className={css.link} onClick={() => scrollToSection(reviewsRef)}>Reviews</NavLink>
                    </li>
                </ul>
